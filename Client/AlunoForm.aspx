<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AlunoForm.aspx.cs" Inherits="Client.AlunoForm" %>
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <asp:TextBox onKeyPress="return formata(this, '§§§.§§§.§§§-§§', event)" class="form-control" MaxLength="15" ID="txtCpf" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="col-5">
                    <div class="form-group">
                        <asp:Label ID="lblTelefone" runat="server" Text="*Telefone"></asp:Label>
                        <asp:TextBox onKeyPress="return formata(this, '(0§§) §§§§-!§§§', event)" class="form-control" MaxLength="15" ID="txtTelefone" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="col-5">
                    <div class="form-group">
                        <asp:Label ID="lblEmail" runat="server" Text="*Email"></asp:Label>
                        <asp:TextBox class="form-control" MaxLength="70" ID="txtEmail" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="col-5">
                    <div class="form-group">
                        <asp:Label ID="lblRa" runat="server" Text="*R.A."></asp:Label>
                        <asp:TextBox onKeyPress="return formata(this, '§§§§-§§§', event)" class="form-control" MaxLength="30" ID="txtRa" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
